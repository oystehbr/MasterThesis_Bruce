...
def add_meter_columns(input_df, origin=None, proj_info=None, load=False, dump=False, latlon_varnames=['Latitude', 'Longitude']):
    """
    ...
    """
    (x, y), proj_info = latlon_to_xy(input_df, origin=origin, proj_info=proj_info,
